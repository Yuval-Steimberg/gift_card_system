...
--
-- Seeds CONFIGURATION ONLY (store location, card designs, settings) — no demo
-- gift cards, so /admin reports real sales from day one. To purge demo rows an
-- older seed already inserted, run supabase/cleanup-demo-data.sql.
-- =============================================================================
